...
app_target = project.new_target(:application, 'SprayWall', :ios, '17.0')
test_target = project.new_target(:unit_test_bundle, 'SprayWallTests', :ios, '17.0')
test_target.add_dependency(app_target)

def configure_target(target, bundle_id:, product_name:)
...
configure_target(app_target, bundle_id: 'com.spraywall.app', product_name: 'SprayWall')
configure_target(test_target, bundle_id: 'com.spraywall.app.tests', product_name: 'SprayWallTests')
